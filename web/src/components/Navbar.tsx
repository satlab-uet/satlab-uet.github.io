    ...
    >
      <div className="section-shell flex items-center justify-between gap-4">
        ...
        >
          ...
          <div>
            ...
            <p className="hidden md:block font-editorial text-[11px] font-normal text-slate-500">
              Satisfiability, Automated Reasoning &amp; Optimization · UET-VNU
            </p>
          </div>
        </button>
        ...
        <div className="flex items-center gap-2.5">
          <a
            href="./read.html"
            className="hidden sm:inline-flex items-center gap-1.5 rounded-xl border border-sky-300 bg-gradient-to-r from-sky-600 to-cyan-700 px-3.5 py-2 font-editorial text-xs font-bold text-white shadow-sm shadow-sky-500/20 hover:from-sky-700 hover:to-cyan-800 transition hover:-translate-y-0.5 focus-ring"
          >
            <Icon name="menu_book" className="h-3.5 w-3.5 text-cyan-200" />
            <span>Read SAT Book</span>
        ...
        <div className="lg:hidden mt-3 border-b border-slate-200/90 bg-white/95 px-5 py-4 backdrop-blur-xl shadow-lg animate-in fade-in slide-in-from-top-2">
          <div className="grid gap-1.5">
            ...
            <div className="pt-2 border-t border-slate-100 mt-1">
              <a
                href="./read.html"
                className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-sky-600 to-cyan-700 py-2.5 text-center font-editorial text-sm font-bold text-white shadow-sm"
              >
                <Icon name="menu_book" className="h-4 w-4 text-cyan-200" />
                <span>Read SAT Book Monograph</span>
              </a>
            </div>
          </div>
        </div>
