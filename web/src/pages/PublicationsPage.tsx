    ...
    <div className="section-shell py-10 sm:py-14 animate-in fade-in duration-300">
      ...
      <div className="max-w-4xl">
        ...
        <p className="mt-4 font-editorial text-lg text-slate-600 leading-relaxed max-w-3xl">
          Comprehensive, searchable catalog of peer-reviewed journal papers, conference proceedings, and
          manuscripts published by the faculty, researchers, and students of SATLab UET.
        </p>
      </div>
