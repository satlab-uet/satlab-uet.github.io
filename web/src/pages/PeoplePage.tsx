    ...
    <div className="section-shell py-10 sm:py-14 animate-in fade-in duration-300">
      ...
      <div className="max-w-4xl">
        ...
        <p className="mt-4 max-w-3xl font-editorial text-lg leading-relaxed text-slate-600">
          Meet the faculty leads, PhD candidates, and active student researchers of SATLab UET, conducting
          fundamental research and solver engineering in propositional satisfiability, MaxSAT, cardinality encodings,
          and combinatorial optimization at VNU University of Engineering and Technology.
        </p>
      </div>
