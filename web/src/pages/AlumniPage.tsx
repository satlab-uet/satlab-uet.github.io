    ...
    <div className="section-shell py-10 sm:py-14 animate-in fade-in duration-300">
      <div className="max-w-4xl">
        ...
        <p className="mt-4 max-w-3xl font-editorial text-lg leading-relaxed text-slate-600">
          SATLab UET takes pride in mentoring outstanding students who author
          top-tier international journal papers (COAP Q1 ISI, RAIRO-OR, Pesquisa),
          earn academic honors, and pursue graduate excellence.
        </p>
      </div>
