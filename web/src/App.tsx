...
export function AppContent() {
  ...
  const getPageTitle = (route: PageRoute): string => {
    switch (route) {
      case 'events':
        return 'News Briefs & Announcements';
      case 'publications':
        return 'Research Publications';
      case 'research':
        return 'Core Research Topics';
      case 'projects':
        return 'Projects & Solvers';
      case 'people':
        return 'Faculty, Researchers & Students';
      case 'book':
        return 'SAT Monograph (Sách Chuyên khảo)';
      case 'alumni':
        return 'Mentorship & Student Honors';
      case 'lab-life':
        return 'Lab Activities & Feed';
      case 'admin':
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-6">
        <div className="text-center">
          ...
          <p className="mt-4 font-editorial text-sm font-semibold text-slate-700">Loading SATLab UET data…</p>
        </div>
      </div>
    );
  }
